...
public class AmenitiesListView extends FrameLayout {
    public AmenitiesListView(@NonNull Context context) {
        super(context);
        init();
    }

    public AmenitiesListView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public AmenitiesListView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    public AmenitiesListView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void init() {
        ...
        addView(amenitiesRv);
        amenitiesRv.setLayoutManager(new LinearLayoutManager(getContext(), LinearLayout.HORIZONTAL, false));
