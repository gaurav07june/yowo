package com.nomad.firebase_service;
...
import com.nomad.activity.Dashboard;
import com.nomad.util.AppConstants;
import com.nomad.util.NotificationUtil;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void handleNotification(String message) {
        if (!NotificationUtil.isAppIsInBackground(getApplicationContext())) {
            ...
            Intent pushNotification = new Intent(AppConstants.FIREBASE_CONFIG.PUSH_NOTIFICATION);
            pushNotification.putExtra("message", message);
            LocalBroadcastManager.getInstance(this).sendBroadcast(pushNotification);
           /* Intent resultIntent = new Intent(getApplicationContext(), Dashboard.class);
            resultIntent.putExtra("message", message);*/
            showNotificationMessage(getApplicationContext(), null, message, null, null);
